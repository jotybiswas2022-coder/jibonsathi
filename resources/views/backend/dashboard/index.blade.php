...
@section('content')
    <div class="stat-grid">
        @foreach ([
            ['lbl' => 'Total Members', 'num' => number_format($counters['total_users']), 'ico' => 'fa-users', 'cls' => 'ic-brand', 'sub' => 'All accounts'],
            ['lbl' => 'Active Members', 'num' => number_format($counters['active_users']), 'ico' => 'fa-user-check', 'cls' => 'ic-success', 'sub' => 'Status: active'],
            ['lbl' => 'Verified Profiles', 'num' => number_format($counters['verified_profiles']), 'ico' => 'fa-circle-check', 'cls' => 'ic-accent', 'sub' => 'Identity verified'],
            ['lbl' => 'Pending Verification', 'num' => number_format($counters['pending_verification']), 'ico' => 'fa-shield-halved', 'cls' => 'ic-warning', 'sub' => 'Awaiting review'],
            ['lbl' => 'Open Reports', 'num' => number_format($counters['reported_profiles']), 'ico' => 'fa-flag', 'cls' => 'ic-danger', 'sub' => 'Pending + investigating'],
            ['lbl' => 'New This Week', 'num' => number_format($counters['new_registrations']), 'ico' => 'fa-user-plus', 'cls' => 'ic-info', 'sub' => 'Last 7 days'],
            ['lbl' => 'Active Conversations', 'num' => number_format($counters['active_conversations']), 'ico' => 'fa-comments', 'cls' => 'ic-brand', 'sub' => 'Messaged in 7 days'],
            ['lbl' => 'Profile Views', 'num' => number_format($counters['profile_views']), 'ico' => 'fa-eye', 'cls' => 'ic-muted', 'sub' => 'All time'],
        ] as $stat)
    ...
    <div class="grid mt-4" style="grid-template-columns: 1.4fr 1fr 1fr">
        <div class="card">
            <div class="card-head">
                            ...
                            <tr>
                                <td>
                                    <div class="cell-user">
                                        ...
                                        <div>
                                            <div class="cu-name"><a href="{{ route('backend.users.show', $u) }}">{{ $u->name }}</a></div>
